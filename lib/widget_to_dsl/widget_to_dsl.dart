...
import 'package:mio/widget_to_dsl/mio_bundle.dart' as dsl;
import 'package:mio/widget_to_dsl/mio_widget.dart' as binding;
...
void main(List<String> arguments) async {
  final parser = ArgParser()
    ...
    ..addOption('compile-kind',
        abbr: 'k', defaultsTo: 'bundle', allowed: ['bundle', 'dart', 'flutter', 'sdk']);
...
void _printResult(String data) {
  if (data != null && data.isNotEmpty) {
    final startTag = '#####################fairc output begin#################';
    final endTag = '#####################fairc output end#################';
    print(startTag);
    print(data);
    print(endTag);
  }
...
void _error(String msg) {
  print(msg);
  throw MioCompileError(msg);
}

class MioCompileError extends Error {
  final String message;
  MioCompileError(this.message);
  @override
