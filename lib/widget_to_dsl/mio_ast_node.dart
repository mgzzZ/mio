...
import 'package:mio/widget_to_dsl/mio_ast_logic_unit.dart';
...
class Identifier extends AstNode {
  ...
  factory Identifier.fromAst(Map ast) {
    ...
    return Identifier('bad -- ${ast['name']}', ast: ast);
  }
...
class MapLiteralEntry extends AstNode {
  ...
  factory MapLiteralEntry.fromAst(Map ast) {
    return MapLiteralEntry(_parseStringValue(ast['key']), Expression.fromAst(ast['value']),
        ast: ast);
  }
...
class Annotation extends AstNode {
  ...
  factory Annotation.fromAst(Map ast) {
    return Annotation(Identifier.fromAst(ast['id']).name, _parseArgumentList(ast['argumentList']),
        ast: ast);
  }
...
class MethodDeclaration extends AstNode {
  ...
  factory MethodDeclaration.fromAst(Map ast) {
    ...
    return MethodDeclaration(name, parameters, BlockStatement.fromAst(ast['body']), annotations,
        TypeName.fromAst(ast['returnType']), ast['source'],
...
class FunctionDeclaration extends AstNode {
  ...
  factory FunctionDeclaration.fromAst(Map ast) {
    return FunctionDeclaration(
        Identifier.fromAst(ast['id']).name, FunctionExpression.fromAst(ast['expression']),
        ast: ast);
  }
...
class MethodInvocation extends AstNode {
  ...
  factory MethodInvocation.fromAst(Map ast) {
    return MethodInvocation(Expression.fromAst(ast['callee']),
        _parseArgumentList(ast['argumentList']), SelectAstClass.fromAst(ast['selectAstClass']),
        ast: ast);
  }
...
class NamedExpression extends AstNode {
  ...
  factory NamedExpression.fromAst(Map ast) {
    return NamedExpression(
        Identifier.fromAst(ast['id']).name, Expression.fromAst(ast['expression']),
        ast: ast);
  }
...
class BinaryExpression extends AstNode {
  ...
  factory BinaryExpression.fromAst(Map ast) {
    return BinaryExpression(
        ast['operator'], Expression.fromAst(ast['left']), Expression.fromAst(ast['right']),
        ast: ast);
  }
...
class AssignmentExpression extends AstNode {
  ...
  factory AssignmentExpression.fromAst(Map ast) {
    return AssignmentExpression(_parseStringValue(ast['operater']), Expression.fromAst(ast['left']),
...
class IfStatement extends AstNode {
  ...
  factory IfStatement.fromAst(Map ast) {
    return IfStatement(BinaryExpression.fromAst(ast['condition']),
        BlockStatement.fromAst(ast['consequent']), BlockStatement.fromAst(ast['alternate']),
        ast: ast);
  }
...
class ForStatement extends AstNode {
  ...
  factory ForStatement.fromAst(Map ast) {
    return ForStatement(
        ForLoopParts.fromAst(ast['forLoopParts']), BlockStatement.fromAst(ast['body']),
        ast: ast);
  }
...
class PropertyAccess extends AstNode {
  ...
  factory PropertyAccess.fromAst(Map ast) {
    return PropertyAccess(Identifier.fromAst(ast['id']).name, Expression.fromAst(ast['expression']),
        ast: ast);
  }
...
class IndexExpression extends AstNode {
  ...
  factory IndexExpression.fromAst(Map ast) {
    return IndexExpression(Expression.fromAst(ast['target']), Expression.fromAst(ast['index']),
        ast: ast);
  }
...
class StringInterpolation extends AstNode {
  ...
  StringInterpolation(this.elements, this.sourceString, {Map? ast}) : super(ast: ast);
