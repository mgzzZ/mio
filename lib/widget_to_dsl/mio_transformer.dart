...
class TransformProxy {
  ...
  String toString() => '<default FloatingActionButton tag>';
    ...
    'snack_bar': AppendTransformer(
        lines: ['const Duration _snackBarDisplayDuration = Duration(milliseconds: 4000);']),
    'paginated_data_table': AppendTransformer(
      importList: ['package:flutter/gestures.dart'],
      lines: ['const int defaultRowsPerPage = 10;'],
    ),
    'popup_menu': AppendTransformer(lines: ['const double _kMenuDividerHeight = 16.0;']),
    ...
    'dismissible': AppendTransformer(importList: ['package:flutter/gestures.dart']),
    ...
    // cupertino
    'activity_indicator':
        AppendTransformer(lines: ['const double _kDefaultIndicatorRadius = 10.0;']),
    ...
    'button': AppendTransformer(lines: ['const double kMinInteractiveDimensionCupertino = 44.0;']),
    ...
    'picker': AppendTransformer(
        lines: ['const double _kDefaultDiameterRatio = 1.07;', 'const double _kSqueeze = 1.45;']),
